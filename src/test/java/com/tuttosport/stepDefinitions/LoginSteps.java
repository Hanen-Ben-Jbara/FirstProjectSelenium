...
public class LoginSteps {
	...
	public void i_enter_the_mail_and_password_correct() {
	    ...
	    //email.sendKeys("anis.fatnassi.c@gmail.com");
	    //password.sendKeys("06061993");
	...
	@When("I enter the mail {string} and {string}")
	public void i_enter_the_mail_and(String email, String password) {
	    // Write code here that turns the phrase above into concrete actions
	...
	public void an_error_is_displayed(String message) {
	    // Write code here that turns the phrase above into concrete actions
